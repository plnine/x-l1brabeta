...
echo "export NIBIRU_WALLET=${CYAN}${NIBIRU_WALLET}" >> $HOME/.bash_profile
echo 'export IDENTITY='${CYAN}${IDENTITY} >> $HOME/.bash_profile
source $HOME/.bash_profile > /dev/null 2>&1
#################################################
printGreen "Completed." && sleep 1


printYellow "6.Initialize the node........"
#################################################
...
printYellow "7.Setting up pruning........" && sleep 1
#################################################
pruning="custom"
